![Logo do projeto](https://imgur.com/3s3u0wT.png)

# Calculadora simples

Esse projeto é sobre uma calculadora simples, feita para fazer operações básicas (somar, subtrair, multiplicar e dividir) e que já serve para resolver algum problema de conta.

## 🔥 Introdução

Este projeto básico de calculadora, serve para resolver algum problema de conta. Ele tem as funcionalidades de somar, subtrair, multiplicar e dividir.
